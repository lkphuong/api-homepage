...
export const addBannerLanguage = async (
  ...
  banner_language.slug = _slugify(title + '-' + Date.now());
  banner_language._slug = _slugify(title);
...
export const editBannerLanguage = async (
  ...
  if (banner_language) {
    ...
    new_banner_language.slug = _slugify(title + '-' + Date.now());
    new_banner_language._slug = _slugify(title);
