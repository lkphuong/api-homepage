...
export const addNotificationLanguage = async (
  ...
  notification_language.slug = _slugify(title + '-' + Date.now());
  notification_language._slug = _slugify(title);
...
export const editNotificationLanguage = async (
  ...
  if (notification_language) {
    ...
    new_notification_language.slug = _slugify(title + '-' + Date.now());
    new_notification_language._slug = _slugify(title);
