...
export const addPositionLanguage = async (
  ...
  position_language.slug = _slugify(title + '-' + Date.now());
  position_language._slug = _slugify(title);
...
export const editPositionLanguage = async (
  ...
  if (position_language) {
    ...
    new_position_language.slug = _slugify(title + '-' + Date.now());
    new_position_language._slug = _slugify(title);
