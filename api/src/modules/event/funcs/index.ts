...
export const addEventLanguage = async (
  ...
  event_language.slug = _slugify(title + '-' + Date.now());
  event_language._slug = _slugify(title);
...
export const editEventLanguage = async (
  ...
  if (event_language) {
    ...
    new_event_language.slug = _slugify(title + '-' + Date.now());
    new_event_language._slug = _slugify(title);
